...
<body>
	...
	2. reebok 이름이 requestScope 에만 추가되어 있다면 객체 이름 생략 가능
		...
		제품 코드 : \${reebok.prodCode} = ${reebok.prodCode}
		제품 이름 : \${reebok.prodName} = ${reebok.prodName}
		제품 가격 : \${reebok.price} = ${reebok.price}
		제품 재고 : \${reebok.quantity} = ${reebok.quantity}
	...
	3. map 으로 추가된 객체를 추출
		...
		제품 전체 : \${adidasMap.S001} = ${adidasMap.S001}
		
		제품 코드 : \${adidasMap.S001.prodCode} = ${adidasMap.S001.prodCode}
		제품 이름 : \${adidasMap.S001.prodName} = ${adidasMap.S001.prodName}
		제품 가격 : \${adidasMap.S001.price} = ${adidasMap.S001.price}
		제품 제고 : \${adidasMap.S001.quantity} = ${adidasMap.S001.quantity}
